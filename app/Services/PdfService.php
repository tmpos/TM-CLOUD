...
final class PdfService
{
    ...
    public function invoiceHtml(array $project, array $invoice): string
    {
        ...
        $qrBlock = '';
        if ($verificationUrl !== '') {
            $qrBlock = '<div class="qr-box"><barcode code="' . $e($verificationUrl) . '" type="QR" size="1.05" error="M" disableborder="1" />'
        ...
        return '<!doctype html><html lang="es"><head><meta charset="utf-8"><title>Factura ' . $invoiceNumber . '</title><style>'
            ...
            . '</style></head><body><main class="page"><header class="hero"><div class="hero-accent"></div><table class="hero-table"><tr><td><div class="invoice-title">FACTURA</div><div class="invoice-subtitle">DOCUMENTO COMERCIAL</div></td><td class="brand-side">' . $logoHtml . '<div class="brand-name">' . $companyName . '</div><div class="brand-rnc">' . ($companyRnc !== '' ? 'RNC ' . $companyRnc : '') . '</div></td></tr></table><div class="hero-line"></div></header><div class="wave"></div>'
