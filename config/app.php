...
return [
    ...
    'apk_max_upload_bytes' => ((int) (getenv('APK_MAX_UPLOAD_MB') ?: 250)) * 1024 * 1024,
    'system_app_max_upload_bytes' => ((int) (getenv('SYSTEM_APP_MAX_UPLOAD_MB') ?: 500)) * 1024 * 1024,
    ...
    'rate_limit' => (int) (getenv('RATE_LIMIT_PER_MINUTE') ?: 300),
