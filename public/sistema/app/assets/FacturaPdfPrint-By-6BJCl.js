import{r as e}from"./rolldown-runtime-hePW80VL.js";import{A as t,v as n}from"./reactivity.esm-bundler-C6Po7tbM.js";import{J as r,P as i,c as a,d as o,g as s,r as c,u as l,v as u}from"./runtime-core.esm-bundler-EoPqhpgY.js";import{f as d,l as f,o as p,t as m,u as h,v as g}from"./tmCloudClient-BXA3SgwJ.js";import{B as _,C as v,M as y,O as b,x,xt as S}from"./index-6v2310m_.js";import{t as C}from"./browser-Cpc4qo6y.js";import{a as w,i as T,n as E,o as D,p as O,r as k}from"./TicketFacturaPrint-ZDB_5P40.js";import{n as A}from"./funciones-BvWR8JyV.js";var j=e(C());function M(e){return e?.data?.signature||e?.data?.request||e?.data||e}function N(e){return JSON.parse(JSON.stringify(e??{}))}function P(e){let t=M(e),n=String(t?.url||``).trim();if(!/^https:\/\//i.test(n))throw Error(`El servidor no devolvió un enlace HTTPS de firma válido`);return{uid:String(t?.uid||``),url:n,expiresAt:t?.expires_at||t?.expiresAt||null,status:t?.status===`signed`?`signed`:`pending`}}function F(e){let t=M(e),n=[`none`,`pending`,`signed`,`stale`,`expired`,`unavailable`].includes(t?.status)?t.status:`none`,r=String(t?.signature_data_uri||t?.signatureDataUri||``).trim();return{status:n,signerName:String(t?.signer_name||t?.signerName||``).trim(),signedAt:t?.signed_at||t?.signedAt||null,imageDataUri:n===`signed`&&/^data:image\/png;base64,[A-Za-z0-9+/=]+$/.test(r)?r:null}}function I(e,t){return[`Hola ${e?.nombre_cliente||`cliente`},`,`Por favor revisa y firma la factura ${e?.no_factura||``} por RD$${Number(e?.total||0).toFixed(2)}.`,`Abre este enlace seguro para firmar:`,t,``,`La factura mostrará tu firma después de confirmarla.`].join(`
`)}async function L(e){let t=String(e?.uid||``).trim();if(!t)throw Error(`La factura aún no tiene UID de sincronización`);if(window.__isServerSystem||window.__isElectron){let n=await window.electron.invoke(`facturas:crearEnlaceFirma`,{record_uid:t,invoice:N(e)});if(n?.success===!1)throw Error(n.error||`No se pudo crear el enlace de firma`);return P(n)}await p(!0);let n=f();if(!n?.url||!n.key)throw Error(`TM Cloud no está configurado para emitir solicitudes de firma`);let r=await fetch(`${n.url}/invoices/${encodeURIComponent(t)}/signature-request`,{method:`POST`,headers:m(n.key,!0),body:JSON.stringify({expires_at:new Date(Date.now()+6048e5).toISOString().replace(`T`,` `).slice(0,19)})});if(!r.ok)throw Error(await g(r));return P(await r.json())}async function R(e){let t=String(e?.uid||``).trim();if(!t)return{status:`none`,signerName:``,signedAt:null,imageDataUri:null};if(window.__isServerSystem||window.__isElectron){let n=await window.electron.invoke(`facturas:obtenerFirma`,{record_uid:t,invoice:N(e)});if(n?.success===!1)throw Error(n.error||`No se pudo consultar la firma`);return F(n)}await p(!0);let n=f();if(!n?.url||!n.key)throw Error(`TM Cloud no está configurado para consultar firmas`);let r=await fetch(`${n.url}/invoices/${encodeURIComponent(t)}/signature`,{headers:m(n.key)});if(!r.ok)throw Error(await g(r));return F(await r.json())}var z={style:{display:`none`}},B={class:`flex flex-col h-full gap-3`},V=[`src`],H=u({__name:`FacturaPdfPrint`,setup(e,{expose:u}){function f(e){let t=k(),n=H(e?.otro,{}),r=e.banco_nombre||n?.banco_nombre||``,i=[],a=Number(e.efectivo||0);a>0&&i.push({tipo:`efectivo`,etiqueta:t.cash,monto:a});let o=H(e.tarjeta_mixta,e.tarjeta_mixta),s=o&&typeof o==`object`?o:n?.tarjeta_mixta||{},c=Number(e.tarjeta||s?.total||Number(s?.monto_base||0)+Number(s?.monto_comision||0));c>0&&i.push({tipo:`tarjeta`,etiqueta:t.card,monto:c});let l=H(e.transferencias_mixtas,e.transferencias_mixtas),u=H(n?.transferencias_mixtas,n?.transferencias_mixtas),d=Array.isArray(l)?l:Array.isArray(u)?u:Number(e.transferencia)>0?[{monto:e.transferencia,banco_nombre:r}]:[];for(let e of d){let n=Number(e?.monto||0);if(n<=0)continue;let r=e?.banco_nombre?` (${e.banco_nombre})`:``;i.push({tipo:`transferencia`,etiqueta:`${t.transfer}${r}`,monto:n})}if(Number(e.cheque)>0&&i.push({tipo:`cheque`,etiqueta:t.check,monto:Number(e.cheque)}),a<=0){let n=Number(e.total||0),r=i.reduce((e,t)=>e+t.monto,0),a=Math.round((n-r)*100)/100;a>.009&&i.unshift({tipo:`efectivo`,etiqueta:t.cash,monto:a})}return i}function m(e){let t=k(),n=String(e.metodo_pago||``).toUpperCase(),r=H(e?.otro,{}),i=e.banco_nombre||r?.banco_nombre||``;if(n!==`MIXTO`){let t=D(e.metodo_pago);return i?`${t} - ${i}`:t}return t.mixed}function g(e){let t=k(),n={efectivo:t.cash,tarjeta:t.card,transferencia:t.transfer,cheque:t.check},r=[...new Set(f(e).map(e=>n[e.tipo].toUpperCase()))];return r.length?`${r.join(` Y `)} - ${t.mixed}`:t.mixed}function C(e){return String(e.tipo_factura||``).toLowerCase()===`cotizacion`||String(e.estado_factura||``).toLowerCase()===`cotizacion`}let M=S(),N=y(),P=n(!1),F=n(!1),I=n(``),L=n(``);function H(e,t){if(e==null)return t;if(typeof e==`string`)try{return JSON.parse(e)}catch{return t}return e}function U(e,t=0){let n=Number(e);return Number.isFinite(n)?n:t}function W(e,t={}){let n=H(e?.otro,{}),r=n?.alanube_response||e?.alanube_response||{};return{documentStampUrl:t?.document_stamp_url||e?.document_stamp_url||e?.documentStampUrl||n?.documentStampUrl||n?.document_stamp_url||r?.documentStampUrl||r?.document_stamp_url||``,securityCode:t?.security_code||e?.codigo_seguridad||e?.securityCode||n?.securityCode||n?.security_code||r?.securityCode||r?.security_code||``,legalStatus:t?.legal_status||e?.alanube_legal_status||r?.legalStatus||n?.legalStatus||``,status:t?.status||e?.alanube_status||r?.status||n?.status||``}}async function G(e){if(e?.id)try{let t=await window.db.getWhere(`facturas_ecf`,`factura_id = ?`,[e.id]),n=t?.success&&Array.isArray(t.data)?t.data[0]:null;if(n)return W(e,n)}catch{}return W(e)}function K(e){return b(e)}function q(e,t=``){let n=String(t||``).trim().match(/^(\d{1,2}:\d{2})/),r=String(e||``).trim(),i=r.match(/(?:T|\s)(\d{1,2}:\d{2})/),a=n?n[1].padStart(5,`0`):i?i[1].padStart(5,`0`):``,o=r.match(/^(\d{4})-(\d{2})-(\d{2})/),s=r.match(/^(\d{2})\/(\d{2})\/(\d{4})/);if(o)return`${o[3]}/${o[2]}/${o[1]}${a?` ${a}`:``}`;if(s)return`${s[1]}/${s[2]}/${s[3]}${a?` ${a}`:``}`;let c=e instanceof Date?e:new Date(e);if(Number.isNaN(c.getTime()))return a;let l=`${String(c.getDate()).padStart(2,`0`)}/${String(c.getMonth()+1).padStart(2,`0`)}/${c.getFullYear()}`,u=`${String(c.getHours()).padStart(2,`0`)}:${String(c.getMinutes()).padStart(2,`0`)}`;return`${l} ${a||u}`}function ee(e){return[e?.imei,e?.lista_imei,e?.imeis,e?.serial,e?.seriales].flatMap(e=>Array.isArray(e)?e:typeof e==`string`?e.split(`,`):e?[e]:[]).map(e=>typeof e==`object`?String(e.imei||e.serial||``).trim():String(e).trim()).filter(Boolean).filter((e,t,n)=>n.indexOf(e)===t)}function te(e){return String(e?.codigo||e?.codigo_barra||e?.cod_producto||e?.sku||e?.referencia||e?.barcode||e?.imei||e?.serial||e?.accesorio_id||e?.telefono_id||e?.imei_id||e?.serial_id||``).trim()}function J(e,t=``){let n=String(e??``).trim();return n?/^(data:|https?:\/\/|file:|blob:)/i.test(n)?n:n.startsWith(`/`)?t?`${t.replace(/\/$/,``)}${n}`:n:t?`${t.replace(/\/$/,``)}/${n.replace(/^\.\//,``)}`:n:``}function Y(e){let t=new Uint8Array(e),n=``,r=32768;for(let e=0;e<t.length;e+=r)n+=String.fromCharCode(...t.subarray(e,e+r));return btoa(n)}async function ne(e,t=``){let n=String(e??``).trim();if(!n)return``;let r=J(n,t);if(/^data:/i.test(r))return r;if(!/^(https?:\/\/|file:|blob:|\/)/i.test(n))try{await p();let e=d(n),t=h()?.key||``;if(e){let n=await fetch(e,{headers:t?{Authorization:`Bearer ${t}`}:{}});if(n.ok)return`data:${n.headers.get(`content-type`)||`image/png`};base64,${Y(await n.arrayBuffer())}`}}catch{}return r}async function re(){try{let e=await window.db.getAll(`empresa`);if(e.success&&e.data?.length>0)return e.data[0]}catch{}return{}}async function ie(e){try{let t=await window.db.getAll(`clientes`);if(!t.success||!Array.isArray(t.data))return{};let n=String(e.cod_cliente||e.cliente_id||``).trim(),r=String(e.nombre_cliente||e.cliente||e.comprador||``).trim().toUpperCase(),i=String(e.telefono_cliente||e.telefono||e.whatsapp||``).trim(),a=String(e.rnc_cliente||e.cedula_cliente||e.rnc||e.cedula||``).trim();return t.data.find(e=>String(e.id||``)===n||String(e.codigo||``)===n||String(e.nombre||``).trim().toUpperCase()===r||String(e.telefono||``).trim()===i||String(e.whatsapp||``).trim()===i||String(e.rnc||``).trim()===a||String(e.cedula||``).trim()===a)||{}}catch{return{}}}function ae(e,t={}){return{nombre:e.nombre_cliente||e.cliente||e.comprador||t?.nombre||`CONSUMIDOR FINAL`,telefono:e.telefono_cliente||e.telefono||e.whatsapp||t?.telefono||t?.whatsapp||``,documento:e.rnc_cliente||e.cedula_cliente||e.rnc||e.cedula||t?.rnc||t?.cedula||``,direccion:e.direccion_cliente||e.direccion||t?.direccion||``}}function oe(e){return String(e.nota||e.observacion||e.observaciones||e.nota_factura||e.comentario||``).trim()}async function se(){try{return await A(`datosarchivo`)}catch{return{}}}async function ce(){try{let e=await window.db.getAll(`impresoras_config`);return e?.success&&Array.isArray(e.data)&&e.data[0]||{}}catch{return{}}}function X(e,t,n,r){let i=Number(e);return Number.isFinite(i)?Math.min(r,Math.max(n,i)):t}function Z(e){return String(e||``).replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e]||e)}async function Q({factura:e,cliente:t=null,datosEmpresa:n=null,signature:r=null}){let i=k(),a=(await se())?.VITE_LINKURL||``,o=n?.empresa||n?.datosEmpresa?.empresa||e.empresa||await re(),s=t||await ie(e),c=T({factura:e,empresa:o,cliente:s}),l={...ae(e,s),...c.customer};l.nombre=w(l.nombre);let u=(oe(e)||i.thanks).replace(/\n/g,`<br>`),d=c.items,p=await ne(o?.logoprinter||o?.logo,a),h=await ce(),_=X(h.factura_logo_ancho,150,30,400),v=X(h.factura_logo_alto,90,20,250),y=await G(e),b=y.documentStampUrl||`${a||`https://tmposrd.com`}/receipt/factura?factura=${e.no_factura||``}`,x=e.qr||``;try{x||=await j.toDataURL(b)}catch{}let S=Array.isArray(d)?d.map(e=>{let t=U(e.cantidad??e.quantity,0),n=U(e.precio_final??e.precio_venta??e.precio_unitario??e.precio,0),r=U(e.precio_normal??e.precio_lista??e.precio_venta_normal,n),i=U(e.descuento,0),a=U(e.impuesto_venta??e.impuesto,0),o=U(e.total,n*t-i),s=r>0&&n>=0&&n<r;return{...e,codigoProducto:te(e),cantidad:t,precioUnidad:n,precioNormal:r,descuento:i,tieneDescuentoProducto:s,impuestoTotal:a*t,totalProducto:o,imeis:ee(e),detallesImei:E(e)}}):[],D=U(e.impuesto??e.impuestos)>0||S.some(e=>e.impuestoTotal>0),A=U(e.descuento)>0||S.some(e=>e.descuento>0),M=S.reduce((e,t)=>e+t.impuestoTotal,0)||U(e.impuesto??e.impuestos),P=U(e.total),F=U(e.subtotal,P+U(e.descuento)-M),I=String(e.metodo_pago||``).toUpperCase()===`MIXTO`,L=I?P:F,R=(I?f(e):[]).map(e=>`<tr class="payment-row"><td>${e.etiqueta}</td><td class="text-right">${K(e.monto)}</td></tr>`).join(``),z=5+ +!!D+ +!!A,B=q(e.fecha_emision||e.fecha||``,e.hora||``),V=i.language===`en`?`CUSTOMER DETAILS`:`DATOS DEL CLIENTE`,H=i.language===`en`?`PAYMENT SUMMARY`:`RESUMEN DE PAGO`,W=C(e)?i.quote.toUpperCase():e.metodo_pago===`CREDITO`?i.creditInvoice:i.invoice.toUpperCase(),J=S.map(e=>{let t=e.detallesImei.length?e.detallesImei.map(e=>`<div class="imei-line">IMEI: ${e}</div>`).join(``):e.imeis.length?`<div class="imei-line">IMEI: ${e.imeis.join(`, `)}</div>`:``,n=e.tieneDescuentoProducto?`<div class="discount-line">Normal: <span class="line-through">${K(e.precioNormal)}</span> &nbsp; Con descuento: <strong>${K(e.precioUnidad)}</strong></div>`:``;return`
      <tr class="invoice-line">
        ...
        <td class="text-right">${K(e.precioUnidad)}</td>
        ${D?`<td class="text-right">${K(e.impuestoTotal)}</td>`:``}
        ${A?`<td class="text-right">${K(e.descuento)}</td>`:``}
        <td class="text-right"><strong>${K(e.totalProducto)}</strong></td>
      </tr>
    `}).join(``),Y=Array.from({length:Math.max(0,8-S.length)},()=>`<tr class="invoice-line empty-row">${Array.from({length:z},()=>`<td>&nbsp;</td>`).join(``)}</tr>`).join(``);return`<!DOCTYPE html>
...
<body>
  <div class="page">
    <div class="header">
      <div class="company">
        ...
        <div class="company-copy">
          ...
          <div class="company-meta">
            ${o.legal||o.rnc?`${N.businessIdLabel}: ${o.legal||o.rnc}<br>`:``}
      ...
      <div class="invoice-box">
        <div class="document-heading">
          <div class="document-type">${W}</div>
          ${!C(e)&&O(e)?`<div class="document-type">${O(e).toUpperCase()}</div>`:``}
          <div class="document-number">${e.no_factura||``}</div>
        </div>
        <table>
          <tr><td><strong>${i.date}</strong></td><td class="text-right">${B}</td></tr>
          ${C(e)||!(e.ncf||e.comprobante)?``:`<tr><td><strong>${N.fiscalDocumentLabel}</strong></td><td class="text-right">${e.ncf||e.comprobante||``}</td></tr>`}
        </table>
        <div class="invoice-title">${C(e)?`${i.quote.toUpperCase()} #${e.no_factura||``}`:e.metodo_pago===`CREDITO`?`${i.creditInvoice} #${e.no_factura||``}`:I?g(e):`${i.invoice.toUpperCase()} #${e.no_factura||``}`}</div>
    ...
    <div class="client-box">
      <div class="client-data">
        ...
        <div class="client-grid">
          ...
          <p><strong>${N.customerIdLabel.toUpperCase()}:</strong><br>${l.documento||i.notApplicable}</p>
    ...
    <div class="bottom">
      ...
      <div class="totals">
        <div class="totals-title">${H}</div>
        <table>
          <tr><td>${i.subtotal}</td><td class="text-right">${K(L)}</td></tr>
          ${D?`<tr><td>${N.shortName}</td><td class="text-right">${K(M)}</td></tr>`:``}
          ${A?`<tr><td>${i.discount}</td><td class="text-right">${K(e.descuento)}</td></tr>`:``}
          ${R}
          <tr><td>${i.total}</td><td class="text-right">${K(e.total)}</td></tr>
        </table>
      </div>
    </div>
...
</html>`}async function le(e,t){I.value&&URL.revokeObjectURL(I.value),I.value=e,L.value=t,P.value=!0}function $(){I.value&&URL.revokeObjectURL(I.value),I.value=``,L.value=``,P.value=!1}async function ue(){if(!I.value)return;let e=`data:application/pdf;base64,${Y(await(await(await fetch(I.value)).blob()).arrayBuffer())}`,t=await window.electron.invoke(`save:pdf`,e,L.value);t.success?M.add({severity:`success`,summary:`Guardado`,detail:`PDF descargado`,life:2e3}):M.add({severity:`error`,summary:`Error`,detail:t.error||`No se pudo guardar el PDF`,life:3e3})}async function de(e){F.value=!0;try{let t=null;if(!C(e)&&e?.uid)try{t=await R(e)}catch{M.add({severity:`warn`,summary:`Firma no disponible`,detail:`El PDF se generará sin firma porque no se pudo consultar el servidor.`,life:4500})}let n=await Q({factura:e,signature:t}),r=`Factura_${e?.no_factura||`sin_numero`}.pdf`,i=await window.electron.invoke(`generate:pdf`,n,r);if(i.success&&i.dataUrl){let e=await(await fetch(i.dataUrl)).blob();await le(URL.createObjectURL(e),r)}else M.add({severity:`error`,summary:`Error`,detail:i.error||`No se pudo generar el PDF`,life:3e3})}catch(e){M.add({severity:`error`,summary:`Error`,detail:e.message||`Error al generar PDF`,life:3e3})}finally{F.value=!1}}return u({printFactura:de,generateFacturaHtml:Q}),(e,n)=>(i(),o(c,null,[a(`div`,z,[s(t(_))]),s(t(x),{visible:P.value,"onUpdate:visible":n[0]||=e=>P.value=e,header:`Vista Previa - Factura PDF`,modal:``,style:{width:`80vw`,height:`90vh`},draggable:!1,onHide:$},{footer:r(()=>[s(t(v),{label:`Cerrar`,severity:`secondary`,text:``,onClick:$}),s(t(v),{label:`Descargar PDF`,icon:`pi pi-download`,onClick:ue})]),default:r(()=>[a(`div`,B,[I.value?(i(),o(`iframe`,{key:0,src:I.value,class:`w-full flex-1 border-0 rounded-lg`,style:{"min-height":`70vh`},title:`Factura PDF`},null,8,V)):l(``,!0)])]),_:1},8,[`visible`])],64))}});export{R as i,I as n,L as r,H as t};