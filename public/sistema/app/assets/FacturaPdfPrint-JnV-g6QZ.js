import{r as e}from"./rolldown-runtime-hePW80VL.js";import{_ as t,k as n}from"./reactivity.esm-bundler-CoVOkjw3.js";import{K as r,N as i,c as a,d as o,g as s,r as c,u as l,v as u}from"./runtime-core.esm-bundler-rmv8K8AY.js";import{f as d,l as f,o as p,t as m,u as h,v as g}from"./tmCloudClient-DVBYrPlo.js";import{C as _,O as v,d as y,q as b,s as x,x as S}from"./index-BApG51kI.js";import{t as C}from"./browser-Cpc4qo6y.js";import{a as w,i as T,n as ee,o as E,r as D}from"./TicketFacturaPrint-oaqokxna.js";import{n as O}from"./funciones-CZsKWvmS.js";var k=e(C());function A(e){return e?.data?.signature||e?.data?.request||e?.data||e}function j(e){return JSON.parse(JSON.stringify(e??{}))}function M(e){let t=A(e),n=String(t?.url||``).trim();if(!/^https:\/\//i.test(n))throw Error(`El servidor no devolvió un enlace HTTPS de firma válido`);return{uid:String(t?.uid||``),url:n,expiresAt:t?.expires_at||t?.expiresAt||null,status:t?.status===`signed`?`signed`:`pending`}}function N(e){let t=A(e),n=[`none`,`pending`,`signed`,`stale`,`expired`,`unavailable`].includes(t?.status)?t.status:`none`,r=String(t?.signature_data_uri||t?.signatureDataUri||``).trim();return{status:n,signerName:String(t?.signer_name||t?.signerName||``).trim(),signedAt:t?.signed_at||t?.signedAt||null,imageDataUri:n===`signed`&&/^data:image\/png;base64,[A-Za-z0-9+/=]+$/.test(r)?r:null}}function P(e,t){return[`Hola ${e?.nombre_cliente||`cliente`},`,`Por favor revisa y firma la factura ${e?.no_factura||``} por RD$${Number(e?.total||0).toFixed(2)}.`,`Abre este enlace seguro para firmar:`,t,``,`La factura mostrará tu firma después de confirmarla.`].join(`
