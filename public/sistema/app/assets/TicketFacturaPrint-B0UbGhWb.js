...
<head>
  ...
  <style>
    * { box-sizing: border-box; font-family: Arial, Helvetica, sans-serif; }
    ...
    html { width: ${f}mm; margin: 0; padding: 0; background: #fff; }
    body { width: ${f}mm; margin: 0; padding: 0 3mm; background: #fff; color: #000; font-size: 10px; overflow: hidden; }
    ...
    .qr-code img { display: block; width: ${f===58?112:130}px; height: ${f===58?112:130}px; margin: 0 auto; }
...
<body>
  <div class="ticket">
    ...
    ${A(a.show_totals)?`<div class="summary">
      ...
      ${p>0?`<div class="summary-row"><span>${o.discount}</span><strong>${c}${N(p)}</strong></div>`:``}
      ${m>0?`<div class="summary-row"><span>${y.shortName}</span><strong>${c}${N(m)}</strong></div>`:``}
