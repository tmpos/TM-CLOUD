...
<body>
  <div class="ticket">
    ...
    ${A(a.show_totals)?`<div class="summary">
      ...
      ${p>0?`<div class="summary-row"><span>${y.shortName}</span><strong>${c}${N(p)}</strong></div>`:``}
