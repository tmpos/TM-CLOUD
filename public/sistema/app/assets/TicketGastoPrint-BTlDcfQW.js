...
<head>
  <style>
    * { font-size: 10px; font-family: Arial, Helvetica, sans-serif; }
    ...
    .ticket { width: ${u}px; padding-top: 10px; padding-bottom: 10px; }
